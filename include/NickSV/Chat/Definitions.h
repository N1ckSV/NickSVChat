...
/// @brief
/// PROTOBUF USING NICKSVCHAT_PROTO_API JUST LIKE WE USING NICKSVCHAT_API,
/// BUT WE CANT INCLUDE CURRENT HEADER TO PROTO HEADERS, SO NICKSVCHAT_PROTO_API
/// DEFINED GLOBALLY AND PRIVATELY BY CMAKE. 
/// WHEN LIB USER IMPORTING SYMBOLS CURRENT HEADER SHOULD
/// BE INCLUDED TO HAVE NICKSVCHAT_PROTO_API AS ABOVE
#undef NICKSVCHAT_PROTO_API
#define NICKSVCHAT_PROTO_API NICKSVCHAT_API
